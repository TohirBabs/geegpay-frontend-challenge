...
export const TrendCard = ({ data }) => {
  return (
    <div className="border cursor-pointer rounded-2xl md:p-3 p-2 lg:h-[48%] h-max justify-between shadow hover:shadow-md bg-[#fff] transition dark:bg-[#000] dark:hover:bg-[#1e2020]/30 dark:border-gray-600/30   md:flex-1 md:w-max flex-1 flex flex-col md:gap-2 gap-1 text-[#26282c] dark:text-[#e5e6e6]">
      ...
      <div className="flex md:gap-2 gap-1 items-center w-max text-xs">
        ...
        >
          {data.trendUp ? <TrendingUp /> : <TrendingDown />}
          <p> {data.percent}%</p>
        </div>
